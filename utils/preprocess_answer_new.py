...
def load_v2(thresh):
    ...
    #occurence = filter_answers(train_answers, thresh)

    print(f'{len(filter_answers(train_answers, 10))} answers in thresh {10}')
    print(f'{len(filter_answers(train_answers, 15))} answers in thresh {15}')
    print(f'{len(filter_answers(train_answers, 25))} answers in thresh {25}')
    print(f'{len(filter_answers(train_answers, 50))} answers in thresh {50}')
    print(f'{len(filter_answers(train_answers, 100))} answers in thresh {100}')
    raise
